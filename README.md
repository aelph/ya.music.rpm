...
Чтобы не нарушать лицензионные права правообладателя, в этом репозитории не хранится сам бинарный файл. Скрипт просто автоматизирует процесс конвертации официального пакета, предоставленного Яндексом, для вашей локальной системы.
